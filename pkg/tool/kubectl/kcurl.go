...
Usage:
  ./ckyn kcurl (<token_path>|anonymous|default) (get|post) <url> [<post_data>]
...
Example: 
  ./ckyn kcurl default get 'https://192.168.0.234:6443/api/v1/nodes'
  ./ckyn kcurl /var/run/secrets/kubernetes.io/serviceaccount/token get 'https://192.168.0.234:6443/api/v1/nodes'
  ./ckyn kcurl anonymous post 'https://192.168.0.234:6443/api/v1/nodes' '{"apiVersion":"v1",...}'
`
